...
grid_path = DATA_PATH+'ClimSim_low-res_grid-info.nc'
...
#i is the 'year' index. The low-res data has up to 8 years of data. 
#This loops through all of them
for i in range(1,9):
    if i == 1:
        lower = 2
    else:
    ...
    #j is the month index, which also gets loops through
    for j in tqdm(range(lower,13)):
        #Set the file names appropriately for the given year/month
        if j < 10:
